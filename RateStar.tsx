...
const RateStar = (props: any) => {
    ...
    const updateStars = (event: any) => {
        ...
        const starNumber = event.target.getAttribute("star-id");
    ...
    for (let i = 0; i < 5; i++) {
        stars.push(
            <svg onMouseEnter={updateStars} star-id={i} key={i} style={{fill: starArray[i] ? "#fff" : "#303030" }} className="star" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 497.9 475.78">
                <title>star</title>
...
// If you like it star it : https://github.com/StamateValentin/Star-Rating-Component-React
